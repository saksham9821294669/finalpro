  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
        <h3>Sauraha</h3>
        <p>We had such a great time in Sauraha!</p>
      </div>   
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        <h3>Meghauli</h3>
        <p>Thank you for visiting Meghauli!</p>
      </div>   
    </div>
    <div class="carousel-item">
...
<div class="container-fluid">
  <div class="row">
	...
	<div class="container-fluid">
	 ...
	 <div class="container">
	 <p style="font-family: 'Lobster', cursive; font-weight:light;  font-size:25px;">Welcome to Food Hunt, your trusted partner for fast and convenient food delivery. Our mission is to connect you with the best local restaurants, offering a wide variety of fresh and delicious meals delivered right to your doorstep. With an easy-to-use platform and quick service, we ensure that every meal you order arrives hot and ready to enjoy. Whether you're craving your favorite comfort food or looking to try something new, we've got you covered. At Food Hunt, we prioritize quality, speed, and excellent customer service to make your food delivery experience seamless and enjoyable.</p>
	 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	   ...
	   <div class="col-sm-6">
	        ...
	        <div class="container">
	        <!--paragraph content--> 
	             <p style="font-family: 'Lobster', cursive; font-weight:light; font-size:25px;">At Food Hunt, we believe in making food delivery a breeze. With just a few clicks, you can explore a variety of cuisines, place your order, and relax while we handle the rest. Whether you're at home, at the office, or anywhere in between, our goal is to ensure that you enjoy fresh, high-quality meals whenever you need them. We take pride in our partnerships with local restaurants, delivering a wide selection of dishes that cater to every taste. Fast, reliable, and customer-focused—let us satisfy your cravings today!</p>
	        </div>
	  </div>
